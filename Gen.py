...
#magic_circle.addLayer( Constellation(image_size, 15, 175, 2, fg_color, trans_col))
#magic_circle.addLayer( Rose(image_size, 32, 150, 2, fg_color, trans_col, 4, 5))
magic_circle.addLayer( MaurerRose(image_size, 32, 150, 1, fg_color, trans_col, 6, 71))
#magic_circle.addLayer( Star(image_size, 9, 150, 2, fg_color, trans_col))
...
magic_circle.addLayer( LineRing(image_size, 350, 25, 64, 2, fg_color, trans_col))
